...
const input = {
  ...
  information: {
    ...
    description: "Recovery my institutional email: jhon@ccae.ufpb.br",
    serviceType: EZimbraKindService.PasswordRecovery,
  },
};
...
const ticketMock: Ticket = {
  ...
  information: {
    ...
    description: "Recovery my institutional email: jhon@ccae.ufpb.br",
    serviceType:
      ZIMBRA_KIND_SERVICE.options[EZimbraKindService.PasswordRecovery],
  },
};
...
describe("e2e: GTIC > Email Zimbra:", () => {
  describe("Recovery Email Password", () => {
    ...
    test("[step 8] - Input: 2: Password Recovery - Answer: How can you describe your solicitation?", () => {
